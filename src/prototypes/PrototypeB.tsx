 ...
 *
 * Inherits: All of Prototype A
 * Adds: Causal explanation inline expansion with three named factor blocks
 *
...
export function PrototypeB() {
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 10 }}>
        ...
        <div style={{ fontFamily: fonts.family.sans, fontSize: 13, lineHeight: 1.5 }}>
          <span style={{ color: "#374151", fontWeight: fonts.weight.semibold }}>Solar generation peaks 12:00–15:00</span>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 10 }}>
        ...
        />
        <div style={{ fontFamily: fonts.family.sans, fontSize: 13, lineHeight: 1.5 }}>
          <span style={{ color: "#374151", fontWeight: fonts.weight.semibold }}>Grid tariff is £0.10/kWh until 18:00</span>
  ...
  return (
    <Shell>
      ...
      <TemporalNav variant="solid" showCausalContext={true} />
    </Shell>
  );
}